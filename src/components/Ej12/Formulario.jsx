...
const Formulario = () => {
  ...
  const noticias = async () => {
    const res = await fetch(
      `https://newsapi.org/v2/top-headlines?country=${pais}&category=${datoSelect}&apiKey=8757d978c18642e4b389db7651989d28`
    );
  ...
  return (
    <>
      <h1>Noticias</h1>
      <Form.Select aria-label="Default select example" onChange={selectPais}>
        <option value="ar">Seleccione un pais</option>
